const Text = {
    ...
    handleMiddleNode(){
      ...
      if(this.sNode === this.eNode) return;

      let iNode = this.sNode.nextSibling;
      while(iNode) {
       console.log(iNode);
        if(iNode.nodeType === 3) {
          midTextNodes.push(iNode);
        } else if(iNode.nodeType === 1) {
          midElementNodes.push(iNode);
        }
      ...
      console.log(midTextNodes, midElementNodes);
