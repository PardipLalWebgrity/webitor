const Text = {
    ...
    documentClick: (e) => {
        ...
        if (t.closest('[data-editor-action]')) {
            ...
            //console.log(rangeNodes.end.node); - Start here

            // Selection
            //Text.selectByNodesAndOffsets(rangeNodes.start.node, rangeNodes.start.sIndex, rangeNodes.end.node, rangeNodes.end.eIndex, );
